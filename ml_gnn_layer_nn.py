...
class CCPGraph(torch.nn.Module):
    ...
    def __init__(self, u_shape, hidden_dim_1, hidden_dim_2, hidden_dim_3,
        ...
        self.conv1 = Conv(36, hidden_dim_1)
        ...
        self.lin1 = nn.Linear( self.u_shape[0]+hidden_dim_3, hidden_dim_6)

        # self.lin1 = nn.Linear(hidden_dim_3, hidden_dim_6) # no position
        ...
        self.lin = nn.Linear(hidden_dim_8, 1)
